...
public class NotificationService {
    ...
    private List<UserDTO> getUsersToAlert(ProductMessage productMessage) throws JsonProcessingException {

        DateFormat df = new SimpleDateFormat("yyyy-MM-dd");
        final String uri = String.format("http://%s:18082/alert/%s/%s/%s/users",
                usersService,
